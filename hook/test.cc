...
void watch_io_read()
{
    moczkrin::IOManager::GetThis()->addEvent(sock_listen_fd, moczkrin::IOManager::READ, test_accept);
}
...
void test_accept()
{
    ...
    else
    {
        ...
        moczkrin::IOManager::GetThis()->addEvent(fd, moczkrin::IOManager::READ, [fd]()
                                              {
            char buffer[1024];
...
void test_iomanager()
{
    ...
    moczkrin::IOManager iom(1);
    iom.addEvent(sock_listen_fd, moczkrin::IOManager::READ, test_accept);
}
