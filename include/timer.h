...
class Timer : public std::enable_shared_from_this<Timer>
{
  ...
  private:
	...
	struct Comparator
	{
		bool operator()(const std::shared_ptr<Timer> &t1,
		    const std::shared_ptr<Timer> &t2) const
		{
			assert(t1 != t2);
